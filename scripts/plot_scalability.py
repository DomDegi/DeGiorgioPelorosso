...
try:
    ...
    print(f"Error: Could not find {data_file}. Please download it from the cluster first.")
    exit()
...
# 3. Plot the data
plt.plot(df['Rows'], df['Time_Seconds'], marker='o', linestyle='-', color='#1f77b4', linewidth=2, markersize=8)
